...
setup(
    name=f"amdshark-devtools{PACKAGE_SUFFIX}",
    version=f"{PACKAGE_VERSION}",
    author="Stella Laurenzo",
    description="AMD-SHARK Development Tools",
    ...
    url="https://github.com/nod-ai/AMD-SHARK-devtools",
    python_requires=">=3.8",
    zip_safe=True,
    ...
    entry_points={
        "console_scripts": [
            "amdshark-ws = amdshark_devtools.workspace.__main__:main"
        ],
    },
    install_requires=[],
)
